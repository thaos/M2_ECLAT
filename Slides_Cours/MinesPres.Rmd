...
Master en statistiques + thèse à CLS en sciences de environnent + Post-doc au CNRM
...
Ce cours reflète mon expérience personnelle dans les sciences du climat. Donc pas un cours exhaustif et surement avec des lacunes.
...
=======
--- 
>>>>>>> 710e2cd3a11e59cedff1a73e4d08f41844703dc4
# Mode de variabilité
...
1. Définir la variable climatique d'intérêt. <em>e.g. temperature, precipitation, ... </em> 

2. Définir le degré d'aggrégation spatiale et temporelle. 	<em>e.g. maximum en  Europe de moyenne sur 10 jours des température</em> 

3. Définir le conditionnement. <em>e.g. seulement en été, ou pour la circulation atmosphérique de type NAO+, ...</em> 

4. Définir la statistique d'intérêt. <em>.e.g. dépassement de seuil</em> 
...
où $\color{purple}{X_{all}}$ est la réponse determimiste de la varible climatique variable $X$ aux forcages externes. On suppose que $X$ est un indicateur de l'intensité du changement climatique.
...
Une courte introduction pour 
  ...
  - parler de quelques considérations pratique sur la correction de bias et son évaluation.
...
- Variables individuelles (marginales), </br>
  e.g. temperature à point de grille 
