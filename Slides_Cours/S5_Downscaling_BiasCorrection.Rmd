...
i.e. $X$ et $Y$ suivent les lois de probabiltés qui sont définis respectivement par les fonctions de répartition $F$ et $G$.
...
ou en tous cas que la loi de $T(X)$ se rappoche de la loi de $Y$.
...
La variable large échelle $X$ est simplement transformée pour avoir la même esperance (moyenne) que la variable $Y$.
...
En pratique, on remplace l'esperance par la moyenne empirique
