...
Cette séances reprend la trame et beaucoup d'éléments du chapite 2 de Coles
...
Dans le cas  où les $X_t$ sont i.i.d.,
$$\begin{align}
...
$$f_{X \mid  Y=y} (x) = f_{X} (x) \quad \text{for all } x,y.$$
...
Soit $(X1, . . . , Xn)$ un n-échantillon de v.a.r. de loi $\mathcal N(\mu, \sigma^2)$.
...
Soit $(X1, . . . , Xn)$ un n-échantillon de v.a.r. i.i.d.
